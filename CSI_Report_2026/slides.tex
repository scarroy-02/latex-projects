...
\begin{frame}{A bit of background}
    \begin{columns}[T]
        \begin{column}{0.55\textwidth}
            \textbf{Persistence diagram.} Sweep a threshold $t$ over the
            sublevel sets $\{f\le t\}$ of a function $f\colon X\to\R$.
            \begin{itemize}
            ...
            \end{itemize}
            \vspace{0.2em}
            $\Dgm(f)$ = the multiset of all such birth--death pairs.\\[0.4em]
